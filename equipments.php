    ...
    <section class="banner-header section-padding bg-img" data-overlay-dark="5" data-background="img/slider/1.jpg">
        <div class="v-bottom">
            <div class="container">
                <div class="row">
                    <div class="col-md-12">
                        <h6 class="animate-box" data-animate-effect="fadeInUp">Equipment</h6>
                        <h1 class="animate-box" data-animate-effect="fadeInUp">Equipment Lists</h1>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="container">
            ...
            <?php if ($result->num_rows > 0) : ?>
                ...
                <div class="col-md-4 gallery-masonry-wrapper single-item cardio">
                    <a href="./Admin/Home/<?= $row['equipment_path'] ?>" title="" class="gallery-masonry-item-img-link img-zoom">
                        <div class="gallery-box">
                            <div class="gallery-img"> <img src="./Admin/Home/<?= $row['equipment_path'] ?>" class="img-fluid mx-auto d-block" alt="" style="width: 300px; height: 300px;"> </div>
